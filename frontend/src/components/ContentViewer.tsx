// ============================================================================
// מציג תוכן לימודי (ContentViewer)
// ----------------------------------------------------------------------------
// תפקיד:
//   מרנדר פריט תוכן בודד בהתאם לסוגו: טקסט/HTML עשיר, תמונה, וידאו (כולל
//   הטמעת YouTube), קישור למסמך (PDF/Office) או קישור חיצוני.
//   כולל פונקציית sanitizeHtml לניקוי HTML מסוכן לפני הצגה.
//
// מבנה עיקרי:
//   • ContentItem — טיפוס פריט התוכן (content_type קובע כיצד יוצג).
//   • sanitizeHtml / preserveLineBreaks / looksLikeHtml — עזרי טיפול בתוכן HTML.
//   • RichText — רכיב פנימי המציג תוכן HTML מנוקה או טקסט רגיל.
//
// הקשר במערכת:
//   משמש בדף הפרק (ChapterPage) להצגת פריטי התוכן של הפרק.
// ============================================================================
