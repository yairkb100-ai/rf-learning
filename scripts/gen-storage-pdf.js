...
const mdFile = path.join(__dirname, 'STORAGE_REPORT.md');
const pdfFile = path.join(__dirname, 'STORAGE_REPORT.pdf');
...
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  h1 { color:#a435f0; font-size:2.3em; margin:20px 0 10px; text-align:center; }
  h2 { color:#a435f0; font-size:1.6em; margin:30px 0 15px; border-bottom:3px solid #a435f0; padding-bottom:8px; page-break-after:avoid; page-break-before:always; }
  ...
  code { background:#f5f5f5; padding:2px 6px; border-radius:3px; font-family:'Courier New',monospace; color:#d63384; direction:ltr; display:inline-block; }
  @media print { h2:first-of-type { page-break-before:avoid; } }
</style></head>
...
(async () => {
  ...
  try {
    ...
    await page.pdf({
      ...
      headerTemplate: '<div style="width:100%;text-align:center;font-size:9px;color:#999;">לומדת ענף 71 — דוח אחסון</div>',
