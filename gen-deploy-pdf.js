...
const mdFile = path.join(__dirname, 'DEPLOY.md');
const pdfFile = path.join(__dirname, 'DEPLOY.pdf');
...
(async () => {
  ...
  try {
    ...
    await page.pdf({
      ...
      headerTemplate: '<div style="width:100%;text-align:center;font-size:9px;color:#999;">לומדת ענף 71 — מדריך פריסה</div>',
